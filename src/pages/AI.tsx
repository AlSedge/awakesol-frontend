...
import { fetchAiArticles, SanityArticle } from '../lib/sanity';
...
export default function AI() {
  ...
  useEffect(() => {
    fetchAiArticles()
      ...
      .catch(err => console.error("Error fetching AI articles:", err))
    ...
    <div className="min-h-screen bg-slate-50 font-sans">
      <header className="bg-white border-b border-slate-200 py-6 px-4 md:px-8 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <Link to="/" className="text-sm font-bold text-blue-600 hover:text-blue-700">Home</Link>
        </div>
      </header>

      <main className="max-w-5xl mx-auto px-4 py-12 md:px-8">
        <div className="mb-12">
          <h2 className="text-4xl font-extrabold text-slate-900 mb-4 tracking-tight">Demystifying AI</h2>
          <p className="text-lg text-slate-600 max-w-2xl font-medium leading-relaxed">
            Learn how to leverage artificial intelligence for everyday tasks, productivity, and creative exploration without needing a degree in computer science.
          </p>
        </div>
        ...
        {loading ? (
            ...
            {articles.map((article) => (
              ...
              >
                ...
                <div className="p-8 flex-grow flex flex-col">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-3 group-hover:text-blue-600 transition-colors">{article.title}</h3>
          ...
          <div className="bg-white rounded-3xl p-12 text-center border border-slate-200 border-dashed">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-2">Processing data...</h3>
            <p className="text-slate-500 max-w-md mx-auto">We are currently writing our beginner-friendly AI guides. Check back soon!</p>
          </div>
        )}
      </main>
    </div>
